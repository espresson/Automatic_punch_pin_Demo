...
import com.ziwenl.self_service.utils.AccessibilityUtil
...
class MainActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
     ...
     //   AccessibilityUtil.autoOpenAccessibilityService(applicationContext)
        //添加快捷方式
...
//        startLive();
        //        startLive();
//        if (KParameter.Kind.INSTANCE.isAccessibilitySettingsOn(this)) {
//            startLive()
//        } else {
//            showConfirmDialog("需要开启无障碍权限。",
